...
import { signOut, useSession } from '@/src/shared/auth/clientSession';
    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          <Link href="/admin/cms" title="PaceMakers Admin"
            style={{ display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none' }}>
            <span style={{ fontSize: 20, flexShrink: 0 }}>🏛️</span>
            {!collapsed && (
              <div>
                <div style={{ fontWeight: 800, fontSize: 13, color: '#fff', lineHeight: 1 }}>PaceMakers Admin</div>
