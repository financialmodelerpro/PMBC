...
import { useSession } from '@/src/shared/auth/clientSession';
...
export default function PagesAdminPage() {
  ...
  useEffect(() => {
    // The original leaned on NextAuth's looser types here. The local shim types
    // `session` as nullable, which is more honest: 'authenticated' and a present
    // session are two separate facts, so check both.
