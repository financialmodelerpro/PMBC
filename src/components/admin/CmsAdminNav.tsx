...
const NAV: NavEntry[] = [
  ...
  { kind: 'item', label: 'Content', href: '/admin/content', icon: Type },
  {
    kind: 'item',
    label: 'Branding',
    href: '/admin/branding',
  ...
  { kind: 'divider', label: 'Inbox' },
  { kind: 'item', label: 'Contact Submissions', href: '/admin/contact-submissions', icon: Inbox },
