...
`verify-valuation-dashboard` (447, the results page end to end, with the phone field lined up with the fields above it, the year end month, P/E and the resume link, at 1440, 1024 and 390, including the partner portrait's 4:5 frame and source ratio,
