...
|-----|-----------|---------|
| `/` | home | The firm in full: hero, firm introduction, what we do, firm track record, firm credentials, who we serve, delivery approach, founder card, network, quote, CTA. **/about was merged into this page and now 301s here** (migration 045). The founder card is the full `founder_block` treatment (portrait, credentials line, bio, proof points, both CTAs), restored by migration 046 after 045 had briefly reduced it to a one-line mention. |
