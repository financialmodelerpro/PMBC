...
**Resume point:** Phases 2 to 7 are complete and merged, and every Growth migration (083 to 093) is applied; nothing is pending. No test rows remain in any Growth table (checked 2026-09-23). Everything runs in mock mode until the keys listed under Open items are set.
