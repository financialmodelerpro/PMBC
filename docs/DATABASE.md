...
- **DDL** migrations (031, 032, 033, 072, 076, 077, 082) use `ALTER TABLE`, which supabase-js cannot
...
Run every migration in order, and remember that **031, 032, 033, 072, 076, 077 and 082 are DDL and
need the Supabase SQL editor**: supabase-js cannot execute `ALTER TABLE` and this
repository has no direct Postgres connection string. All seven are applied and
