...
091  growth_meetings         **DDL, HAND-RUN.** Phase 5: growth_meetings (unique Bookings appointment id, outcome only when held, mock never a Bookings row, brief with mock flag, notes and outcome), growth_messages.meeting_id, settings bookings_url. Applied 2026-09-23. Later Growth migrations: see docs/PENDING_MIGRATIONS.md
```
