...
090  growth_website_chat     **DDL, HAND-RUN.** Phase 4: growth_conversations (details only with consent; consent wording and time recorded; opt-in needs consent) and growth_chat_messages; settings chat_widget_enabled (default false), limits, consent wording, lead_alert_email; unique Growth lead per valuation tool lead. Applied 2026-09-23. Later Growth migrations: see docs/PENDING_MIGRATIONS.md
```
