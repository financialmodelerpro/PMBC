...
095  growth_chat_opening     **DDL, HAND-RUN.** Settings chat_auto_open (default true), chat_auto_open_delay_seconds (20, 5 to 300) and chat_auto_open_scroll_percent (50, 10 to 100). Applied 2026-09-23. Later Growth migrations: see docs/PENDING_MIGRATIONS.md
```
