...
093  growth_intelligence     **DDL, HAND-RUN.** Phase 7: growth_scoring_reviews (suggested weights sum to 100, rejection needs a note). Applied 2026-09-23. Later Growth migrations: see docs/PENDING_MIGRATIONS.md
```
